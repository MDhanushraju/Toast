    ...
    <div className="space-y-6 font-sans pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        {filteredMeetings.length === 0 ? (
          <div className="col-span-2 bg-white dark:bg-[#121e2d] border-2 border-[#006094]/30 rounded-3xl p-12 text-center font-sans space-y-4 shadow-sm">
            <div className="w-16 h-16 rounded-full bg-[#E6F0F6] dark:bg-slate-800 text-[#006094] dark:text-sky-300 flex items-center justify-center mx-auto shadow-inner">
              <FiCheckCircle size={36} />
            </div>
            <h3 className="text-2xl font-montserrat font-black text-[#006094] dark:text-white">
              No Active Meetings Scheduled
            </h3>
            <p className="text-base text-slate-600 dark:text-slate-300 font-bold max-w-md mx-auto">
              Meeting workspace is completely clean. Click below to start setup for a new Toastmasters Demo Meeting.
            </p>
            <div className="pt-2">
              <Button 
                variant="primary" 
                size="md" 
                onClick={handleCreateBooklet} 
                className="bg-[#781327] hover:bg-[#580d1b] border-0 cursor-pointer font-montserrat text-white shadow-xl font-black text-base px-6 py-3.5 rounded-2xl"
              >
                <FiPlus className="mr-2" size={20} /> Create New Demo Meeting
              </Button>
            </div>
          </div>
        ) : (
