  ...
  return (
    <div className="min-h-screen w-full bg-[#FAF5EF] dark:bg-[#070d14] flex flex-col justify-center font-sans antialiased text-slate-900 dark:text-white">
      <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 bg-gradient-to-br from-[#006094] via-[#004165] to-[#002b45] text-white p-10 lg:p-16 flex flex-col justify-between relative overflow-hidden shadow-2xl border-r-4 border-[#003a5c]">
          ...
          <div className="relative z-10 my-12 space-y-10 max-w-3xl">
            <div className="space-y-4">
              <span className="text-sm sm:text-base font-montserrat font-black uppercase tracking-[0.3em] text-amber-300 block">
                DISTRICT 227 SAAS OPERATIONS
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-montserrat font-black leading-tight tracking-tight text-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 font-montserrat">
              <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 p-6 rounded-3xl space-y-3 shadow-xl hover:bg-white/15 transition-all">
                <div className="w-14 h-14 rounded-2xl bg-[#781327] text-white flex items-center justify-center shadow-lg shrink-0">
                  <FiFileText size={28} />
                </div>
                <h4 className="font-black text-lg sm:text-xl text-white">3-Step Booklets</h4>
                <p className="text-xs sm:text-sm text-sky-100 font-bold leading-normal">Before, During & After meeting workflow automation.</p>
              </div>

              <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 p-6 rounded-3xl space-y-3 shadow-xl hover:bg-white/15 transition-all">
                <div className="w-14 h-14 rounded-2xl bg-[#006094] text-white flex items-center justify-center shadow-lg border-2 border-white/30 shrink-0">
                  <FiClock size={28} />
                </div>
                <h4 className="font-black text-lg sm:text-xl text-white">Live Stopwatch</h4>
                <p className="text-xs sm:text-sm text-sky-100 font-bold leading-normal">Real-time speaker timing & green/yellow/red indicators.</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 p-6 rounded-3xl space-y-3 shadow-xl hover:bg-white/15 transition-all">
                ...
                <h4 className="font-black text-lg sm:text-xl text-white">28 Divisions & Areas</h4>
                <p className="text-xs sm:text-sm text-sky-100 font-bold leading-normal">Complete District 227 leadership directory access.</p>
              </div>
            </div>
          </div>

          {/* Bottom Footer Quote & Motto */}
          <div className="relative z-10 pt-8 border-t-2 border-white/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 font-montserrat">
        ...
        {/* 🔐 RIGHT PANEL: Full Page Authentication Portal (5 Cols) - Super Large */}
        <div className="lg:col-span-5 bg-white dark:bg-[#121e2d] p-10 lg:p-16 flex flex-col justify-center space-y-8 overflow-y-auto">
          ...
          {authMode === 'register' && (
            <form onSubmit={handleRegisterSubmit} className="space-y-6 font-sans max-h-[750px] overflow-y-auto pr-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-sm sm:text-base font-black text-[#006094] dark:text-sky-300 uppercase tracking-wider font-montserrat mb-2">PASSWORD *</label>
                  <input type="password" value={regPassword} onChange={(e) => setRegPassword(e.target.value)} placeholder="••••••••" required className="w-full bg-white dark:bg-slate-950 border-2 border-[#006094]/40 text-base sm:text-lg font-black rounded-2xl p-4.5 text-slate-900 dark:text-white focus:ring-4 focus:ring-[#006094]/30 shadow-sm" />
                </div>
              </div>
