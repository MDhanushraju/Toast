...
Official Report Generated under Toastmasters District 227 Corporate Guidelines.
  ...
  return (
    <div className="space-y-6 font-sans">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-4.5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-montserrat font-extrabold text-xs sm:text-sm rounded-xl flex items-center gap-2 transition-all shadow-md cursor-pointer border border-emerald-500"
            >
      ...
      <div className="bg-white dark:bg-[#121e2d] border-2 border-emerald-500/30 rounded-3xl p-6 shadow-sm no-print space-y-3 mt-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 className="font-montserrat font-extrabold text-base text-slate-900 dark:text-white flex items-center gap-2">
              <FiCheckCircle className="text-emerald-500" size={20} /> Conclude & Store in Meeting History
            </h3>
            <p className="text-xs text-slate-500 font-medium mt-1">
